package ryd.checknm.dashboard.module.iot.plugin.http.upstream;

import ryd.checknm.dashboard.module.iot.api.device.IotDeviceUpstreamApi;
import ryd.checknm.dashboard.module.iot.plugin.http.config.IotPluginHttpProperties;
import ryd.checknm.dashboard.module.iot.plugin.http.upstream.router.IotDeviceUpstreamVertxHandler;
