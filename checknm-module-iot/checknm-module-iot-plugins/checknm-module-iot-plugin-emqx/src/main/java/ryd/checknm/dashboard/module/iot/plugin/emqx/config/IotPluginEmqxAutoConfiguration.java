package ryd.checknm.dashboard.module.iot.plugin.emqx.config;
...
import ryd.checknm.dashboard.module.iot.plugin.emqx.downstream.IotDeviceDownstreamHandlerImpl;
import ryd.checknm.dashboard.module.iot.plugin.emqx.upstream.IotDeviceUpstreamServer;
...
public class IotPluginEmqxAutoConfiguration {
    ...
    public MqttClient mqttClient(Vertx vertx, IotPluginEmqxProperties emqxProperties) {
        MqttClientOptions options = new MqttClientOptions()
                .setClientId("checknm-iot-downstream-" + IdUtil.fastSimpleUUID())
