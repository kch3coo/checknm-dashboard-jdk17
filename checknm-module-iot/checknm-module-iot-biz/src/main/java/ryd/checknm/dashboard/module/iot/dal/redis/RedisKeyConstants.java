package ryd.checknm.dashboard.module.iot.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * VALUE 数据类型：String 数组(JSON)，即 {@link ryd.checknm.dashboard.module.iot.dal.dataobject.thingmodel.IotThingModelDO} 列表
     */
