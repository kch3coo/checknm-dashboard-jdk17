...
import ryd.checknm.dashboard.module.iot.dal.mysql.ota.IotOtaFirmwareMapper;
...
import static ryd.checknm.dashboard.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_NOT_EXISTS;
import static ryd.checknm.dashboard.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_PRODUCT_VERSION_DUPLICATE;
...
public class IotOtaFirmwareServiceImpl implements IotOtaFirmwareService {
     ...
     * @throws ryd.checknm.dashboard.framework.common.exception.ServiceException，则抛出异常，提示固件信息已存在
     */
