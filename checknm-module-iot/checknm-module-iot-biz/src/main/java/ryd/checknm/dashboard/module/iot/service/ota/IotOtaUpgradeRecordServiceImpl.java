package ryd.checknm.dashboard.module.iot.service.ota;

import cn.hutool.core.convert.Convert;
import ryd.checknm.dashboard.framework.common.pojo.PageResult;
import ryd.checknm.dashboard.framework.common.util.object.ObjectUtils;
import ryd.checknm.dashboard.module.iot.controller.admin.ota.vo.upgrade.record.IotOtaUpgradeRecordPageReqVO;
...
import ryd.checknm.dashboard.module.iot.dal.dataobject.ota.IotOtaUpgradeRecordDO;
import ryd.checknm.dashboard.module.iot.dal.dataobject.ota.IotOtaUpgradeTaskDO;
import ryd.checknm.dashboard.module.iot.dal.mysql.ota.IotOtaUpgradeRecordMapper;
import ryd.checknm.dashboard.module.iot.enums.ota.IotOtaUpgradeRecordStatusEnum;
...
import static ryd.checknm.dashboard.module.iot.enums.ErrorCodeConstants.*;
...
public class IotOtaUpgradeRecordServiceImpl implements IotOtaUpgradeRecordService {
     ...
     * @throws ryd.checknm.dashboard.framework.common.exception.ServiceException，则抛出异常，异常类型为OTA_UPGRADE_RECORD_NOT_EXISTS。
     */
     ...
     * @throws ryd.checknm.dashboard.framework.common.exception.ServiceException，则抛出 OTA_UPGRADE_RECORD_CANNOT_RETRY 异常
     */
