...
import ryd.checknm.dashboard.module.iot.dal.mysql.ota.IotOtaUpgradeTaskMapper;
import ryd.checknm.dashboard.module.iot.enums.ota.IotOtaUpgradeTaskScopeEnum;
import ryd.checknm.dashboard.module.iot.enums.ota.IotOtaUpgradeTaskStatusEnum;
...
public class IotOtaUpgradeTaskServiceImpl implements IotOtaUpgradeTaskService {
     ...
     * @throws ryd.checknm.dashboard.framework.common.exception.ServerException 则抛出预定义的异常
     */
     ...
     * @throws ryd.checknm.dashboard.framework.common.exception.ServiceException，抛出相应的异常
     */
     ...
     * @throws ryd.checknm.dashboard.framework.common.exception.ServiceException 如果升级任务不存在，则抛出异常提示任务不存在
     */
