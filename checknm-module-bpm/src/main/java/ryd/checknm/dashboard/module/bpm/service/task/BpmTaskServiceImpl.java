...
import ryd.checknm.dashboard.framework.common.util.object.ObjectUtils;
import ryd.checknm.dashboard.framework.common.util.object.PageUtils;
...
import ryd.checknm.dashboard.module.bpm.controller.admin.task.vo.task.*;
import ryd.checknm.dashboard.module.bpm.convert.task.BpmTaskConvert;
...
import ryd.checknm.dashboard.module.bpm.enums.definition.*;
import ryd.checknm.dashboard.module.bpm.enums.task.BpmCommentTypeEnum;
import ryd.checknm.dashboard.module.bpm.enums.task.BpmReasonEnum;
import ryd.checknm.dashboard.module.bpm.enums.task.BpmTaskSignTypeEnum;
...
import ryd.checknm.dashboard.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import ryd.checknm.dashboard.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
...
import ryd.checknm.dashboard.module.bpm.service.definition.BpmFormService;
import ryd.checknm.dashboard.module.bpm.service.definition.BpmModelService;
import ryd.checknm.dashboard.module.bpm.service.definition.BpmProcessDefinitionService;
import ryd.checknm.dashboard.module.bpm.service.message.BpmMessageService;
import ryd.checknm.dashboard.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static ryd.checknm.dashboard.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static ryd.checknm.dashboard.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
import static ryd.checknm.dashboard.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_SKIP_START_USER_NODE;
import static ryd.checknm.dashboard.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 checknm-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
    ...
    public void processTaskCreated(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
             ...
             * 参见 <a href="https://gitee.com/zhijiantianya/checknm-cloud/issues/IB7V7Q">issue</a> 反馈
             */
            @Override
