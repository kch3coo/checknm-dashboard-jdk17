...
import ryd.checknm.dashboard.framework.tracer.core.aop.BizTraceAspect;
import ryd.checknm.dashboard.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "checknm.tracer", value = "enable", matchIfMissing = true)
public class ChecknmTracerAutoConfiguration {
