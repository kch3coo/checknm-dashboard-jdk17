...
import ryd.checknm.dashboard.framework.common.enums.DocumentEnum;
import ryd.checknm.dashboard.framework.mq.redis.core.RedisMQTemplate;
import ryd.checknm.dashboard.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import ryd.checknm.dashboard.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import ryd.checknm.dashboard.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import ryd.checknm.dashboard.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class ChecknmRedisMQConsumerAutoConfiguration {
