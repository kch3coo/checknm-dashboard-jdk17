 ...
 *      1）Spring Async：
 *          {@link ryd.checknm.dashboard.framework.quartz.config.ChecknmAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ChecknmSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package ryd.checknm.dashboard.framework.tenant;
