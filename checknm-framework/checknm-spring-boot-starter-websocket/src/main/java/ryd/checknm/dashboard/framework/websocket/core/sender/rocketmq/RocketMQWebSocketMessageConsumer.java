package ryd.checknm.dashboard.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${checknm.websocket.sender-rocketmq.topic}",
        consumerGroup = "${checknm.websocket.sender-rocketmq.consumer-group}",
