...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "ryd.checknm.boot";
    private static final String ARTIFACT_ID = "checknm";
    private static final String PACKAGE_NAME = "ryd.checknm.dashboard";
    private static final String TITLE = "CheckNM 管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "ryd.checknm.boot";
        String artifactIdNew = "checknm";
        String packageNameNew = "ryd.checknm.dashboard";
        String titleNew = "CheckNM 管理系统";
