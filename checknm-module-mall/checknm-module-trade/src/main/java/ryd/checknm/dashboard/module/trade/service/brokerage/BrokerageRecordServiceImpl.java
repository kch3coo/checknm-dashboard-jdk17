...
import ryd.checknm.dashboard.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
...
import ryd.checknm.dashboard.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import ryd.checknm.dashboard.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static ryd.checknm.dashboard.framework.common.util.collection.CollectionUtils.getMaxValue;
import static ryd.checknm.dashboard.framework.common.util.collection.CollectionUtils.getMinValue;
import static ryd.checknm.dashboard.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static ryd.checknm.dashboard.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
