package ryd.checknm.dashboard.module.crm.dal.redis.no;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import ryd.checknm.dashboard.module.crm.dal.redis.RedisKeyConstants;
...
public class CrmNoRedisDAO {
    ...
    /**
     * 合同 {@link ryd.checknm.dashboard.module.crm.dal.dataobject.contract.CrmContractDO}
     */
    public static final String CONTRACT_NO_PREFIX = "HT";

    /**
     * 回款 {@link ryd.checknm.dashboard.module.crm.dal.dataobject.receivable.CrmReceivablePlanDO}
     */
