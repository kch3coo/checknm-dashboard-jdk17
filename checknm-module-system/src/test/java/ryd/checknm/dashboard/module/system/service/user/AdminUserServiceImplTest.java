package ryd.checknm.dashboard.module.system.service.user;
...
import ryd.checknm.dashboard.framework.common.util.collection.ArrayUtils;
...
import ryd.checknm.dashboard.module.infra.api.config.ConfigApi;
import ryd.checknm.dashboard.module.infra.api.file.FileApi;
...
import ryd.checknm.dashboard.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import ryd.checknm.dashboard.module.system.controller.admin.user.vo.user.UserImportRespVO;
import ryd.checknm.dashboard.module.system.controller.admin.user.vo.user.UserPageReqVO;
import ryd.checknm.dashboard.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import ryd.checknm.dashboard.module.system.dal.dataobject.dept.UserPostDO;
import ryd.checknm.dashboard.module.system.dal.dataobject.tenant.TenantDO;
import ryd.checknm.dashboard.module.system.dal.dataobject.user.AdminUserDO;
import ryd.checknm.dashboard.module.system.dal.mysql.dept.UserPostMapper;
import ryd.checknm.dashboard.module.system.dal.mysql.user.AdminUserMapper;
import ryd.checknm.dashboard.module.system.enums.common.SexEnum;
...
import static ryd.checknm.dashboard.module.system.enums.ErrorCodeConstants.*;
import static ryd.checknm.dashboard.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("checknmyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("checknmyuanma");
        ...
        assertEquals("checknmyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("checknmyuanma"))).thenReturn("java");
