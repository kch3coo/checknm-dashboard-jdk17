package ryd.checknm.dashboard.module.system.service.social;
...
import ryd.checknm.dashboard.framework.common.util.cache.CacheUtils;
import ryd.checknm.dashboard.framework.common.util.http.HttpUtils;
import ryd.checknm.dashboard.framework.common.util.object.BeanUtils;
import ryd.checknm.dashboard.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import ryd.checknm.dashboard.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import ryd.checknm.dashboard.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import ryd.checknm.dashboard.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import ryd.checknm.dashboard.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import ryd.checknm.dashboard.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import ryd.checknm.dashboard.module.system.dal.dataobject.social.SocialClientDO;
import ryd.checknm.dashboard.module.system.dal.mysql.social.SocialClientMapper;
...
import ryd.checknm.dashboard.module.system.framework.justauth.core.AuthRequestFactory;
...
import static ryd.checknm.dashboard.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${checknm.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${checknm.wxa-subscribe-message.miniprogram-state:formal}")
