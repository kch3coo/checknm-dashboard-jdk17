package ryd.checknm.dashboard.module.system.service.tenant;
...
import ryd.checknm.dashboard.framework.tenant.config.TenantProperties;
...
import ryd.checknm.dashboard.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import ryd.checknm.dashboard.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import ryd.checknm.dashboard.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import ryd.checknm.dashboard.module.system.convert.tenant.TenantConvert;
...
import ryd.checknm.dashboard.module.system.dal.dataobject.tenant.TenantPackageDO;
import ryd.checknm.dashboard.module.system.dal.mysql.tenant.TenantMapper;
import ryd.checknm.dashboard.module.system.enums.permission.RoleCodeEnum;
import ryd.checknm.dashboard.module.system.enums.permission.RoleTypeEnum;
...
import ryd.checknm.dashboard.module.system.service.tenant.handler.TenantInfoHandler;
import ryd.checknm.dashboard.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 checknm.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
