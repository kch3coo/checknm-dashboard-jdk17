package ryd.checknm.dashboard.module.system.controller.admin.socail.vo.client;
...
public class SocialClientRespVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "checknm商城")
    private String name;
