package ryd.checknm.dashboard.module.system.controller.admin.dept.vo.post;
...
public class PostSaveReqVO {
    ...
    @Schema(description = "岗位编码", requiredMode = Schema.RequiredMode.REQUIRED, example = "checknm")
