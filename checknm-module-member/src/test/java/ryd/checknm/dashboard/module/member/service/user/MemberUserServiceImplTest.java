...
import ryd.checknm.dashboard.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import ryd.checknm.dashboard.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, ChecknmRedisAutoConfiguration.class})
