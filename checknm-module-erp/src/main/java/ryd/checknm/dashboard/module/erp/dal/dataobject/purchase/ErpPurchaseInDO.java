package ryd.checknm.dashboard.module.erp.dal.dataobject.purchase;
...
public class ErpPurchaseInDO extends BaseDO {
     ...
     * 入库状态
     *
     * 枚举 {@link ryd.checknm.dashboard.module.erp.enums.ErpAuditStatus}
     */
     ...
     * 已支付金额，单位：元
     *
     * 目的：和 {@link ryd.checknm.dashboard.module.erp.dal.dataobject.finance.ErpFinancePaymentDO} 结合，记录已支付金额
     */
