package ryd.checknm.dashboard.module.ai.framework.ai.core;
...
import ryd.checknm.dashboard.module.ai.framework.ai.config.AiAutoConfiguration;
import ryd.checknm.dashboard.module.ai.framework.ai.config.ChecknmAiProperties;
...
import ryd.checknm.dashboard.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            ChecknmAiProperties.MidjourneyProperties properties = SpringUtil.getBean(ChecknmAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#deepSeekChatModel(ChecknmAiProperties)}
     */
    private static DeepSeekChatModel buildDeepSeekChatModel(String apiKey) {
        ChecknmAiProperties.DeepSeekProperties properties = new ChecknmAiProperties.DeepSeekProperties()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDeepSeekChatModel(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(ChecknmAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        ChecknmAiProperties.DouBaoProperties properties = new ChecknmAiProperties.DouBaoProperties()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(ChecknmAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        ChecknmAiProperties.HunYuanProperties properties = new ChecknmAiProperties.HunYuanProperties()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(ChecknmAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        ChecknmAiProperties.SiliconFlowProperties properties = new ChecknmAiProperties.SiliconFlowProperties()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(ChecknmAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        ChecknmAiProperties.XingHuoProperties properties = new ChecknmAiProperties.XingHuoProperties()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(ChecknmAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        ChecknmAiProperties.BaiChuanProperties properties = new ChecknmAiProperties.BaiChuanProperties()
                .setApiKey(apiKey);
