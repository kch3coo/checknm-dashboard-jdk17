package ryd.checknm.dashboard.module.mp.service.account;
...
import ryd.checknm.dashboard.module.mp.convert.account.MpAccountConvert;
import ryd.checknm.dashboard.module.mp.dal.dataobject.account.MpAccountDO;
import ryd.checknm.dashboard.module.mp.dal.mysql.account.MpAccountMapper;
import ryd.checknm.dashboard.module.mp.enums.ErrorCodeConstants;
...
import static ryd.checknm.dashboard.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 checknm-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
