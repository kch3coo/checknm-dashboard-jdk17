package ryd.checknm.dashboard.module.mp.service.message;
...
import ryd.checknm.dashboard.module.mp.dal.mysql.message.MpMessageMapper;
import ryd.checknm.dashboard.module.mp.enums.message.MpMessageSendFromEnum;
import ryd.checknm.dashboard.module.mp.framework.mp.core.MpServiceFactory;
import ryd.checknm.dashboard.module.mp.framework.mp.core.util.MpUtils;
import ryd.checknm.dashboard.module.mp.service.account.MpAccountService;
import ryd.checknm.dashboard.module.mp.service.material.MpMaterialService;
import ryd.checknm.dashboard.module.mp.service.message.bo.MpMessageSendOutReqBO;
import ryd.checknm.dashboard.module.mp.service.user.MpUserService;
...
import static ryd.checknm.dashboard.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
