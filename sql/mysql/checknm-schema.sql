...
CREATE TABLE IF NOT EXISTS machine_info (
  ...
  device_image    mediumblob,
  last_check_time DATETIME,
  last_maintainer varchar(16),
  PRIMARY KEY (id),
  index machine_info_company (company_name)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;


CREATE TABLE IF NOT EXISTS machine_location_info (
  id               int unsigned NOT NULL AUTO_INCREMENT,
  qr_code          varchar(256) NOT NULL,
  machine_id       int unsigned NOT NULL,
  sensor_id        int unsigned,
  location_info    varchar(64) NOT NULL,
  latest_result    tinyint unsigned,
  last_check_time  DATETIME,
  last_maintainer  varchar(16),
  location_image   mediumblob,
  PRIMARY KEY (id),
