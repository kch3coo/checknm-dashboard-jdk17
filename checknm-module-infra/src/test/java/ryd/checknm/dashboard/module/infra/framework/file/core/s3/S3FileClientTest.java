package ryd.checknm.dashboard.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("checknmyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.checknm.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.checknm.iocoder.cn
        // 默认上海的 endpoint
