package ryd.checknm.dashboard.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 ryd.checknm.dashboard.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
