package ryd.checknm.dashboard.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(ryd.checknm.dashboard.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
