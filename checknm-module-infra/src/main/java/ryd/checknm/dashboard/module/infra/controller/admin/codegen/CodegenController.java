package ryd.checknm.dashboard.module.infra.controller.admin.codegen;
...
import ryd.checknm.dashboard.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import ryd.checknm.dashboard.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import ryd.checknm.dashboard.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import ryd.checknm.dashboard.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import ryd.checknm.dashboard.module.infra.convert.codegen.CodegenConvert;
...
import ryd.checknm.dashboard.module.infra.service.codegen.CodegenService;
...
import static ryd.checknm.dashboard.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static ryd.checknm.dashboard.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "checknm"),
